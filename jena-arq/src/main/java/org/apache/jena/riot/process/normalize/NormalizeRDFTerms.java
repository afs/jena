...
public class NormalizeRDFTerms implements NormalizeTerm {
    ...
    private static final NormalizeRDFTerms mapXSD = mappingXSD();
     ...
     * </ul>
     */
    public static NormalizeRDFTerms getXSD() { return mapXSD ; }
    ...
    private static NormalizeRDFTerms mappingXSD() {
        Map<RDFDatatype, DatatypeHandler> mapping = baseMap();
