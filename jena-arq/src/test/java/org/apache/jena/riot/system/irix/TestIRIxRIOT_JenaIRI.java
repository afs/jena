...
public class TestIRIxRIOT_JenaIRI extends AbstractTestIRIxRIOT_system {
    ...
    private static final IRIProvider testProvider = new IRIProviderJenaIRI();
    ...
    @Override @Test public void irix_http_4_nt()          { testDft (httpUri04, Lang.NT, 0, 1); }

    // Different number of warnings.
    @Override @Test public void irix_http_4_nt_check()    { testDft (httpUri04, Lang.NT, 0, 1); }
    @Override @Test public void irix_http_4_ttl()         { testDft (httpUri04, Lang.NT, 0, 1); }

    @Override @Test public void irix_http_5_nt()          { testDft (httpUri05, Lang.NT, 0, 1); }

    @Override @Test public void irix_urn_2_nt()           { testDft (uri09, Lang.NT, 0, 1); }

    @Override @Test public void irix_urn_uuid_2_nt()      { testDft (urnuuid02, Lang.NT, 0, 1); }
