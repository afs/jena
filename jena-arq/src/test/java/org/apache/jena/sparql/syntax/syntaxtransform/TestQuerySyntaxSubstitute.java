...
public class TestQuerySyntaxSubstitute {
    ...
    private void testSubstitute(String qs, Map<Var, ? extends Node> substitutions, String outcome) {
        ...
        try {
            ...
            System.err.println(queryOutcomeString);
            fail("Bad syntax from "+queryOutcomeString);
        }
    }
    ...
    private void testSubstituteVars(String qs, Map<Var, ? extends Node> substitutions, String outcome) {
        ...
        if ( false ) {
            Query query2a = QueryTransformOps.replaceVars(query, substitutions); // need to split
        }
        ...
        Query query2 = QueryTransformOps.transform(query, eltrans, exprTrans);
